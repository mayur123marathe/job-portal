      ...
      <div className="flex h-16 items-center justify-between border-b border-white/5 px-4 shrink-0">
        {!collapsed ? (
          <Link to="/admin/dashboard" className="flex items-center gap-2.5 min-w-0">
            <img src="/logo.png" alt="Mayur Admin" className="h-8 w-8 shrink-0 rounded-lg object-contain shadow-sm" />
            <div className="min-w-0">
              <p className="text-sm font-bold text-white truncate">Mayur Admin</p>
              <p className="text-[10px] text-slate-400 leading-tight">Management Console</p>
            </div>
          </Link>
        ) : (
          <Link to="/admin/dashboard" className="flex items-center justify-center w-full">
            <img src="/logo.png" alt="Mayur Admin" className="h-8 w-8 rounded-lg object-contain shadow-sm" />
          </Link>
        )}
      </div>
